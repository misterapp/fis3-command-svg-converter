...
/**
 * List of must options and warnings.
 * @type {Array}
 */
exports.mustOptions = [{
    option: 'src',
    warning: 'please check the src option,must be a string or reg,refer to node globs'
}, {
    option: 'dest',
    warning: 'please check the dest option,must be a dir'
}, {
    option: 'destStyleFile',
    warning: 'please check the destStyleFile option,must be a file path'
}];
/**
